...
sizeDict = {'kb':2**10, 'kB':2**10*8, 'Mb': 2**20, 'MB':2**20*8, 'Gb': 2**30, 'GB':2**30*8, 'Tb': 2**40, 'TB': 2**40*8}
...
def download_time(filesize, fileUnit, BandWidth, BandWiddthUnit):
    bits1 = filesize * sizeDict[fileUnit]
    bits2 = BandWidth * sizeDict[BandWiddthUnit]
    seconds = bits1 / bits2
